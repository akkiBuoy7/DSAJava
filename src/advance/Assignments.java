...
public class Assignments {
    public static void main(String[] args) {
        ...
        int beggersN = 5;
        execute(beggersN, devotee);
    }

    private static void execute(int beggersN, int[][] devotee) {
        /*
Problem Description
...
Second devotee donated 20 coins to beggars ranging from 2 to 3. Final amount in each beggars pot
after second devotee: [10, 30, 20, 0, 0]
Third devotee donated 25 coins to beggars ranging from 2 to 5. Final amount in each beggars pot
after third devotee: [10, 55, 45, 25, 25]
 */
        int[] beggers = new int[beggersN];
        ...
        for (int[] dev : devotee) {
            ...
            System.out.println("diff array is "+ Arrays.toString(beggers));
        }
        int [] result = new int[beggersN];
        int pref = 0;
        for (int i=0;i<beggers.length;i++){
            pref+= beggers[i];
            result[i] = pref;
        }
